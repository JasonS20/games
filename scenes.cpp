...
void MenuScene::load() {
  _font.loadFromFile("/home/leni/git/set09121_labs/lab_5/resources/fonts/RobotoMono-Regular.ttf");
  _text.setFont(_font);
...
void GameScene::load() {
  ...
  ls::load_level("/home/leni/git/set09121_labs/lab_5/resources/levels/pacman.txt",param::tile_size);
...
void GameScene::respawn() {
 ...
 for (size_t i = 1; i < _entities.list.size(); i++) {
    ...
    ghost->set_position(ls::get_tile_position(ghost_spawns[rand() % ghost_spawns.size()]));
